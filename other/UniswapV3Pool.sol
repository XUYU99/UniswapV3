...
contract UniswapV3Pool is IUniswapV3Pool, NoDelegateCall {
    ...
    int24 test_tickLower;
    int24 test_tickUpper;
    int128 test_liquidityDelta;
    ...
    {
        test_tickLower = params.tickLower;
        test_tickUpper = params.tickUpper;
        test_liquidityDelta = params.liquidityDelta;
        // 校验 tick 区间是否合法
    ...
    // function test001() public view returns (int256 amount0, int256 amount1) {
    //     Slot0 memory _slot0 = slot0;
    //     if (test_liquidityDelta != 0) {
    //         if (_slot0.tick > test_tickUpper) {
    //             amount1 = SqrtPriceMath.getAmount1Delta(
    //                 TickMath.getSqrtRatioAtTick(test_tickLower),
    //                 TickMath.getSqrtRatioAtTick(test_tickUpper),
    //                 test_liquidityDelta
    //             );
    //         }
    //     }
